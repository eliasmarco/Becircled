...
function game_init(){
    ...
    canvas.addEventListener('touchend', click, false);
...
function mouseMove(e){
	...
	if(!pauseForAnim()){
		...
		mouse_X = parseInt(touchobj.clientX)  - document.getElementById('game_canvas').offsetLeft;
		mouse_Y = parseInt(touchobj.clientY) - document.getElementById('game_canvas').offsetTop;
	}
}
...
function mouseDown(e){
	...
	if(!pauseForAnim()){
		...
		mouse_downX = parseInt(touchobj.clientX)  - document.getElementById('game_canvas').offsetLeft;
		mouse_downY = parseInt(touchobj.clientY)  - document.getElementById('game_canvas').offsetTop;
		block1X = Math.floor(((mouse_downX - leftOffset)/tileSizeX));
		block1Y = Math.floor(((mouse_downY - topOffset)/tileSizeY));
		debug = "mouse down @ " + block1X + " " + block1Y;
	}
...
function mouseUp(e){
	...
	if(!pauseForAnim()){
		...
		var touchobj = e.changedTouches[0] 
		mousePressed = false;
		mouse_upX = parseInt(touchobj.clientX) - document.getElementById('game_canvas').offsetLeft;
		mouse_upY = parseInt(touchobj.clientY)  - document.getElementById('game_canvas').offsetTop;
		block2X = Math.floor(((mouse_upX - leftOffset)/tileSizeX));
		block2Y = Math.floor(((mouse_upY - topOffset)/tileSizeY));
